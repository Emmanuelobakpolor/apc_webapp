...
const roles = [
  {
    ...
    description: 'List and manage your properties for sale or rent',
    images: [
  ...
  },
  {
    id: 'agent',
    title: 'I am an Agent',
    description: 'Track sales, manage listings and handle client inquiries',
    images: [
    ...
    <div className="min-h-screen bg-white flex flex-col lg:flex-row">
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-6 sm:px-10 py-16 lg:py-0 animate-in fade-in slide-in-from-left-4 duration-500">
        ...
        <div className="w-full max-w-md">
          <h1 className="text-3xl font-bold text-[#002C3D] mb-1.5">Create an account</h1>
          <p className="text-gray-500 mb-8 font-medium">How would you like to use APC Portal?</p>
