...
const links = [
  ...
  { to: '/owner/agents',      label: 'Agents',      icon: UserCheck       },
  { to: '/owner/users',       label: 'Tenants',     icon: Users           },
      ...
      <div className="px-5 pt-6 pb-4 flex-shrink-0">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            <div className="w-11 h-11 rounded-2xl bg-white/10 border border-white/10 flex items-center justify-center shadow-lg overflow-hidden">
              <img src={apcLogo} alt="APC" className="w-8 h-8 object-cover rounded-lg" />
            </div>
            <div>
        ...
        {/* Welcome card */}
        <div className="mt-5 rounded-2xl bg-white/6 border border-white/10 p-4">
          ...
          <p className="mt-1 text-[12px] text-white/50 leading-relaxed">
            Manage your properties, tenants, and agents from one place.
          </p>
        </div>
      </div>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/6 p-3">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-[11px] text-white/45 truncate">Property Owner</p>
            </div>
          </div>
          <button
